...
// Source: gopkg.in/sqle/vitess-go.v1/vt/tabletserver/txthrottler (interfaces: ThrottlerInterface)
...
import (
	...
	discovery "gopkg.in/sqle/vitess-go.v1/vt/discovery"
	throttlerdata "gopkg.in/sqle/vitess-go.v1/vt/proto/throttlerdata"
)
