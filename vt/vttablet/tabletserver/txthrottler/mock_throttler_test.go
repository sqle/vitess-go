...
// Source: gopkg.in/sqle/vitess-go.v2/vt/tabletserver/txthrottler (interfaces: ThrottlerInterface)
...
import (
	...
	discovery "gopkg.in/sqle/vitess-go.v2/vt/discovery"
	throttlerdata "gopkg.in/sqle/vitess-go.v2/vt/proto/throttlerdata"
)
