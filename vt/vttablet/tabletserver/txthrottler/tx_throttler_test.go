...
//go:generate mockgen -destination mock_toposerver_impl_test.go -package txthrottler gopkg.in/sqle/vitess-go.v2/vt/topo Impl
...
//go:generate mockgen -destination mock_healthcheck_test.go -package txthrottler gopkg.in/sqle/vitess-go.v2/vt/discovery HealthCheck
//go:generate mockgen -destination mock_throttler_test.go -package txthrottler gopkg.in/sqle/vitess-go.v2/vt/tabletserver/txthrottler ThrottlerInterface
//go:generate mockgen -destination mock_topology_watcher_test.go -package txthrottler gopkg.in/sqle/vitess-go.v2/vt/tabletserver/txthrottler TopologyWatcherInterface
